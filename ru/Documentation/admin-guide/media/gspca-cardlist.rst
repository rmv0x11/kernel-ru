...
Модули драйверов веб-камер gspca:

- gspca_main: основной драйвер
- gspca\_\ *driver*: модуль субдрайвера, где *driver* принимает следующие значения

=========	=========	===================================================================
*driver*	vend:prod	Устройство
=========	=========	===================================================================
