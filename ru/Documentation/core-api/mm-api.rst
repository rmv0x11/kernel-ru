...
Доступ к памяти из пространства пользователя
============================================
...
Виртуально непрерывные отображения
==================================

.. kernel-doc:: mm/vmalloc.c
   :export:

Отображение файлов и страничный кэш
===================================
...
Дополнительные функции управления памятью
=========================================
